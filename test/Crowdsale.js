...
describe('Staking', () => {
  ...
  describe('buyTokens', () => {
    it('adds a token symbol', async () => {
      ...
      totalSupply = await ssayCoin.totalSupply()
      signer2Balance = await ssayCoin.balanceOf(signer2.address)
      signer3Balance = await ssayCoin.balanceOf(signer3.address)
      ...
      totalSupply = await ssayCoin.totalSupply()
      signer2Balance = await ssayCoin.connect(owner).balanceOf(signer2.address)
      signer3Balance = await ssayCoin.connect(owner).balanceOf(signer3.address)
